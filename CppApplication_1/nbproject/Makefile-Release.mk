...
${OBJECTDIR}/Euler/Euler.o: Euler/Euler.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Euler/Euler.o Euler/Euler.cpp

${OBJECTDIR}/Euler/GozintaChains/GozintaChains.o: Euler/GozintaChains/GozintaChains.cpp 
	${MKDIR} -p ${OBJECTDIR}/Euler/GozintaChains
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Euler/GozintaChains/GozintaChains.o Euler/GozintaChains/GozintaChains.cpp

${OBJECTDIR}/TopCoder/TopCoder.o: TopCoder/TopCoder.cpp 
	${MKDIR} -p ${OBJECTDIR}/TopCoder
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TopCoder/TopCoder.o TopCoder/TopCoder.cpp
